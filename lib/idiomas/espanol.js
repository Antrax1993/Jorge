...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `𝙎𝙄𝙎𝙆𝙀𝘿-𝘽𝙊𝙏\n\n` } 
...
const smsAvisoEG = () => { return `𝙎𝙄𝙎𝙆𝙀𝘿-𝘽𝙊𝙏\n\n` }
...
const smsAdmin = () => { return `\`\`\`» 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙀𝙎 𝙋𝘼𝙍𝘼 𝘼𝘿𝙈𝙄𝙉.\`\`\`` }//ADMINS
const smsBotAdmin = () => { return `\`\`\`» 𝙉𝙀𝘾𝙀𝙎𝙄𝙏𝙊 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉 𝙋𝘼𝙍𝘼 𝙌𝙐𝙀 𝙋𝙐𝙀𝘿𝘼𝙎 𝙐𝙎𝘼𝙍 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊\`\`\`` }//BOT CON ADMIN
...
@user* 
`}
const smsSpromote = () => { return '*@user* 𝘼𝙃𝙊𝙍𝘼 𝙏𝙄𝙀𝙉𝙀 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎.'}
const smsSdemote = () => { return '*@user 𝘿𝙀𝙅𝘼 𝘿𝙀 𝙏𝙀𝙉𝙀𝙍 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎!!*'}
const smsSdesc = () => { return '*𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝙉𝙐𝙀𝙑𝘼 𝙀𝙎:*\n\n@desc'}
const smsSsubject = () => { return '*𝙀𝙇 𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙀𝙎:*\n\n@subject'}
const smsSicon = () => { return '*𝙎𝙀 𝘾𝘼𝙈𝘽𝙄𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊!!*'}
const smsSrevoke = () => { return '*𝙉𝙐𝙀𝙑𝙊 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊!!*\n\n*@revoke*'}
...
//_allantilink.js
const smsTextoYT = () => { return ' SISKED BOT '} 
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeGB['smsAvisoEG']()}𝙎𝙊𝙇𝙊 𝙋𝙊𝙍 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉 𝙉𝙊 𝙏𝙀 𝘽𝙊𝙍𝙍𝙊 🙄`}
...
//_antiviewonce.js
const smsAntiView = () => { return `*_NADA SE ME ESCAPA CHISME_*`} 
...
//_expired.js
const smsBottem1 = () => { return `‼️ 𝘘𝘶𝘦𝘳𝘪𝘥𝘰 𝘩𝘶𝘮𝘢𝘯𝘰 𝘴𝘦 𝘵𝘦 𝘵𝘦𝘳𝘮𝘪𝘯𝘰́ 𝘦𝘭 𝘵𝘪𝘦𝘮𝘱𝘰 𝘨𝘳𝘢𝘵𝘪𝘴 𝘥𝘦 𝘱𝘳𝘶𝘦𝘣𝘢 𝘥𝘦 SISKED BOT, 𝘱𝘢𝘳𝘢 𝘳𝘦𝘯𝘰𝘷𝘢𝘳 𝘦𝘭 𝘴𝘦𝘳𝘷𝘪𝘤𝘪𝘰 𝘤𝘰𝘯𝘵𝘢́𝘤𝘵𝘢𝘵𝘦 𝘤𝘰𝘯 𝘮𝘪 𝘤𝘳𝘦𝘢𝘥𝘰𝘳.
...
//grupo-tagall.js
const smstagaa = () => { return `𝙎𝙄𝙎𝙆𝙀𝘿-𝘽𝙊𝙏 
*_DESPIERTEN PLANTAS_*`}

//grupo-setbye.js
const smsSetB = () => { return `${lenguajeGB['smsAvisoEG']()}*LA DESPEDIDA DEL GRUPO HA SIDO MODIFICADA*`}
...
//grupo-setwelcome.js
const smsSetW = () => { return `${lenguajeGB['smsAvisoEG']()}*LA BIENVENIDA DEL GRUPO HA SIDO MODIFICADA*`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝙎𝙄𝙎𝙆𝙀𝘿-𝘽𝙊𝙏!!! 😸\n\n💖 𝙎𝙄𝙎𝙆𝙀𝘿-𝘽𝙊𝙏 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
...
const smsContacto4 = () => { return 'Contacto Oficial de SISKED-BOT'}
